...
public class DatabaseDataWorker {
    ...
    private void insertCourse(String courseId, String title) {
        ...
        values.put(Constants.CourseInfoEntry.COLUMN_COURSE_ID, courseId);
        values.put(Constants.CourseInfoEntry.COLUMN_COURSE_TITLE, title);

        long newRowId = db.insert(Constants.CourseInfoEntry.TABLE_NAME, null, values);

    }

     private void insertNote(String courseId, String title, String text) {
        ContentValues values = new ContentValues();
        values.put(Constants.NoteInfoEntry.COLUMN_COURSE_ID, courseId);
        values.put(Constants.NoteInfoEntry.COLUMN_NOTE_TITLE, title);
        values.put(Constants.NoteInfoEntry.COLUMN_NOTE_TEXT, text);

        long newRowId = db.insert(Constants.NoteInfoEntry.TABLE_NAME, null, values);
    }
